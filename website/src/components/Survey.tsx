      ...
      <div className="flex flex-col bg-card p-[80px] rounded-[30px]">
        ...
        <div className="flex justify-center items-center flex-row gap-10">
          ...
          <div className="flex flex-col justify-center items-center gap-5">
            <div className="flex flex-col p-[40px] bg-secondary/40 rounded-[30px]">
            ...
            <Link
              href="/get-started"
              className="group inline-flex items-center justify-center rounded-full border bg-secondary px-5 py-3 text-md font-semibold text-white transition hover:translate-y-[-1px] hover:bg-secondary/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary/60"
              onClick={() =>
          ...
          {/* free trial */}
          <div className="flex flex-col justify-center items-center gap-5">
            <div className="flex flex-col p-[40px] bg-secondary/10 border border-secondary rounded-[30px]">
              <h3 className="flex flex-row text-[30px] font-mediium items-baseline pb-10 justify-center text-center">
                Kostenslos
              </h3>
              <p className="pb-2">Was dir zur Verfügung steht:</p>
            ...
            <Link
              href="/survey"
              className="group inline-flex items-center justify-center rounded-full border border-secondary px-5 py-3 text-md font-semibold  transition hover:translate-y-[-1px] hover:bg-secondary/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary/60"
              onClick={() =>
